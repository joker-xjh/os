...
public class HardDiskBuffer
{
    ...
    public final static int SIZE = BufferBlock.SIZE * 4;
    private CPU cpu;
    private BufferBlock[] blocks;

    public HardDiskBuffer(OS os,InnerMemoryManager innerMemoryManager)
    {
        this.cpu = os.cpu;
        this.blocks = new BufferBlock[4];
        for (int i = 0; i < blocks.length; i++)
        {
            this.blocks[i] = new BufferBlock(os,innerMemoryManager);
        }
    }
